...
export default function ProjectPage() {
  ...
  return <section>
    ...
    <DispatchModal projectId={id} workflow={selectedWorkflow} branches={branches} tags={tags} defaultBranch={defaultBranch} onClose={() => setSelectedWorkflow(null)} onDispatch={async (ref, inputs) => { await api.dispatch(id, selectedWorkflow!.id, ref, inputs); setTimeout(() => void load(), 1500); }} />
  </section>;
}
