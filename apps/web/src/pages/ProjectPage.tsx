...
import { ArrowLeft, ExternalLink, LoaderCircle, Play, Radio, RefreshCw, RotateCcw, XCircle } from 'lucide-react';
...
export default function ProjectPage() {
  ...
  return <section>
    ...
    <div className="section-title"><div><h2>构建记录</h2><p>GitHub 状态变化会自动刷新；点击记录查看 Job、Step 与 Artifact</p></div></div>
